#!/bin/bash
#SBATCH --job-name=ign_mamba_2p8b
#SBATCH --account=ACCOUNT
#SBATCH --gres=gpu:a100:1
#SBATCH --mem=80G
#SBATCH --cpus-per-task=8
#SBATCH --time=48:00:00
#SBATCH --output=/home/AUTHOR/scratch/ignition_index/logs/mamba_2p8b_%j.out
#SBATCH --error=/home/AUTHOR/scratch/ignition_index/logs/mamba_2p8b_%j.err
...
echo "mamba-2.8b Start: $(date)"
python run_model.py --model "mamba-2.8b" --signal_types S1 S2 S3
echo "mamba-2.8b Done: $(date)"
